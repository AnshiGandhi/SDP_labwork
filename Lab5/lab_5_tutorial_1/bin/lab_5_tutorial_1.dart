import 'package:lab_5_tutorial_1/lab_5_tutorial_1.dart' as lab_5_tutorial_1;
...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'JD',
    'Manushi'
  ]; //This is same as , final desserts = const['Anshi','JD','Manushi'];
  // Below 3 will not work because list is const
  // desserts.add('vrushali');
  // desserts.remove('Anshi');
  // desserts[0] = 'abc';

import 'package:lab_2_tutorial_3/lab_2_tutorial_3.dart' as lab_2_tutorial_3;
...
void main() {
  ...
  */
  /*
        ...
        const name = ‘Anshi ';
        message += name; // 'Hello my name is Anshi'
 
        final message = StringBuffer();
        message.write('Hello');
        message.write(' my name is ');
        message.write('Anshi');
        message.toString(); // "Hello my name is Anshi"
  ...
  */
  /*
        ...
        const name = "Anshi ";
        const intro = "Hello , My name is $name"; //Hello my name is Anshi
  ...
  */
  /*
        //Mini-Exercises
          ...
          //1.
          const firstname = "Anshi ";
          const lastname = " Timbadiya ";
